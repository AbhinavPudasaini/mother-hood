...
export default function OnboardingPage() {
            ...
            [
                {
                    ...
                    fields: [
                        ...
                        { name: "days", label: "How many days pregnant?", type: "number", placeholder: "e.g., 18" },
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            document.cookie = `userId=${data.userId}; path=/; max-age=${60 * 60 * 24 * 7}`; // 7 days
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid gap-3">
                ...
                <Row label="Days pregnant" value={form.days} />
